          ...
          >
            {isSubmitting ? (
              <span className="flex items-center gap-2">
                ...
                {isPayment ? "Processing..." : isSend ? "Sending..." : isDelete ? "Deleting..." : isCreate ? "Creating..." : isUpdate ? "Updating..." : "Saving..."}
              </span>
            ) : (
              isPayment ? "Payment" : isSend ? "Send" : isDelete ? "Delete" : isCreate ? "Create" : isUpdate ? "Update" : "Save"
            )}
          </button>
        </div>
      </form>
